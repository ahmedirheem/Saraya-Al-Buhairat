    ...
    <div className="h-full w-full relative">
      ...
      <div>
        <div className="absolute left-[10px] top-20 z-[1000]">
          <MapControlBtn onClick={handleHidePlaces} icon={selectedTypes.length || showPlaces ? 'eyes-dash' : 'eyes'} title={selectedTypes.length || showPlaces ? 'أخفي المعالم' : 'أظهر المعالم'} />
          <MapControlBtn onClick={handleChangeLanguage} text="En" title="غيَر اللغة" />
        </div>

        <div className="absolute left-[10px] bottom-20 z-[1000]">
          <MapControlBtn onClick={handleAskHelp} icon="question" title={t('title')}/>
      ...
      <div className="absolute top-4 right-[10px] z-[1000]">
        ...
        <div className="flex flex-col bg-slate-600 py-4 px-8 rounded-md gap-3">
          ...
          <Button variant="showALl"
            ...
            onClick={handleShowAllBtn}>عرض الكل</Button>
